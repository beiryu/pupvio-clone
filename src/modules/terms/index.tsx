...
const Terms: FC = () => {
  return (
    <div className="py-10">
      <p className="w-[861px] h-10 text-white text-[35px] font-bold font-['Poppins'] leading-[49.22px]">
        Terms of Use
      </p>
      <p className="text-white text-sm font-normal leading-7 py-8">
        December 19, 2023
      </p>
      <p className="text-white text-lg font-bold">1. AGREEMENT TO TERMS</p>
      <p className="text-white text-sm text-normal py-4">
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (&apos;You&apos;) and
        Web3app, operated by Eternal Engine Corporation, Web3app LLC and
        subsidiaries, affiliates, licensees and/or licensors of Eternal Engine
        Corporation, Web3app LLC (&apos;Company&apos;, &apos;we&apos;,
        &apos;us&apos;, or &apos;our&apos;), concerning your access to and use
        of the https://web3app.app website as well as any other media form,
        media channel, mobile website or mobile application (ios) or (android)
        related, linked, or otherwise connected thereto (collectively, the
        &apos;Site&apos;). By accessing, downloading, using or clicking on
        &apos;I agree&apos; to accept any of services provided by the Company,
        You agree that you have read, understood, and agree to be bound by all
        of these Terms and Conditions as well as our Privacy Policy. In
        addition, when using some features, You may be subject to specific
        additional terms and conditions applicable to those features. If you do
      ...
      <p className="text-white text-lg font-bold">2. PROVIDED SERVICES</p>
      <p className="text-white text-sm text-normal py-4">
        The Site is providing an intermediary service, connecting the users with
        crypto currencies. You are invited to connect all your wallets and
        exchanges to Web3app and create a Defi wallet, which allows you to buy,
        sell, swap, track and earn on the crypto from one interface.
      </p>
      <p className="text-white text-sm text-normal py-4">
        However, Web3app is not acting as a platform on which a user may
        purchase, sell and/or swap crypto currencies on the Web3app platform,
        but is acting as an intermediary for users to have access to crypto.
      </p>
      <p className="text-white text-sm text-normal py-4">
        Services provided by Web3app shall not be considered as an investment,
        financial and/or trading advice, and you shall not regard any of its
        content as such.
      </p>
      ...
      <p className="text-white text-sm text-normal py-4">
        ...
        of the United States and other jurisdictions, international copyright
        ...
        use only. Except as expressly provided in these Terms of Use, no part of
      ...
      <p className="text-white text-lg font-bold">4. USER REPRESENTATIONS</p>
      <p className="text-white text-sm text-normal py-4">
        By using the Site or mobile applications, you represent and warrant
      ...
      <p className="text-white text-sm text-normal py-4">
        ...
        and refuse any and all current or future use of the Site or our mobile
        applications (or any portion thereof).
      </p>
      <p className="text-white text-lg font-bold">5. USER REGISTRATION</p>
      <p className="text-white text-sm text-normal py-4">
        You may be required to register with the Site or mobile applications.
        You agree to keep your password confidential and will be responsible for
      ...
      <p className="text-white text-lg font-bold">6. FEES AND PAYMENT</p>
      <p className="text-white text-sm text-normal py-4">
        ...
        may change prices at any time. All payments will be done in the currency
      ...
      <p className="text-white text-lg font-bold">7. FREE TRIAL</p>
      <p className="text-white text-sm text-normal py-4">
        We offer a free trial to new users who register with the Site. The
        account will be charged according to the user&apos;s chosen subscription
        at the end of the free trial.
      </p>
      <p className="text-white text-lg font-bold">8. CANCELLATION</p>
      <p className="text-white text-sm text-normal py-4">
        You can cancel your subscription at any time by contacting us using the
        contract information provided below. Your cancellation will take effect
      ...
      <p className="text-white text-lg font-bold">9. PROHIBITED ACTIVITIES</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-sm text-normal py-4">
        As a user of the Site or mobile applications, you agree not to:
      </p>
      <p className="text-white text-sm text-normal py-4">
        ...
        <br></br>- Trick, defraud, or mislead us and other users, especially in
        any attempt to learn sensitive account information such as user
        passwords.
        <br></br>- Circumvent, disable, or otherwise interfere with
        ...
        <br></br>- Disparage, tarnish, or otherwise harm, in our opinion, us
        and/or the Site or mobile applications.
        <br></br>- Use any information obtained from the Site in order to
        harass, abuse, or harm another person.
        <br></br>- Make improper use of our support services or submit false
        reports of abuse or misconduct.
        <br></br>- Use the Site in a manner inconsistent with any applicable
        laws or regulations.
        <br></br>- Upload or transmit (or attempt to upload or to transmit)
        ...
        <br></br>- Engage in any automated use of the system, such as using
        scripts to send comments or messages, or using any data mining, robots,
        or similar data gathering and extraction tools.
        <br></br>- Delete the copyright or other proprietary rights notice from
        any Content.
        <br></br>- Attempt to impersonate another user or person or use the
        username of another user.
        <br></br>- Upload or transmit (or attempt to upload or to transmit) any
        ...
        <br></br>- Interfere with, disrupt, or create an undue burden on the
        Site or the networks or services connected to the Site.
        <br></br>- Harass, annoy, intimidate, or threaten any of our employees
        or agents engaged in providing any portion of the Site or mobile
        applications to you.
        <br></br>- Attempt to bypass any measures of the Site or mobile
        applications designed to prevent or restrict access to the Site, or any
        portion of the Site.
        <br></br>- Copy or adapt the Site&apos;s or applications software,
        including but not limited to Flash, PHP, HTML, JavaScript, or other
        code.
        <br></br>- Except as permitted by applicable law, decipher, decompile,
        disassemble, or reverse engineer any of the software comprising or in
        any way making up a part of the Site.
        <br></br>- Except as may be the result of standard search engine or
        ...
        <br></br>- Use a buying agent or purchasing agent to make purchases on
        the Site.
        <br></br>- Make any unauthorized use of the Site, including collecting
        ...
        <br></br>- Use the Site as part of any effort to compete with us or
        otherwise use the Site and/or the Content for any revenue-generating
        endeavor or commercial enterprise.
        <br></br>- Use the Site to advertise or offer to sell goods and
        services.
        <br></br>- Sell or otherwise transfer your profile.
      </p>
      <p className="text-white text-lg font-bold">
        10. WEB3APP REWARDS PROGRAM
      </p>
      <p className="text-white text-sm text-normal py-4">
        Web3app reserves the right, in its sole and absolute discretion, to
        void, cancel, or remove any and all Web3app virtual currencies (&apos;So
        named&apos;) a user may have earned or accumulated, at any time and
        without prior notice. This action may be taken if Web3app reasonably
        believes or suspects that our currency or incentives have been obtained
        or accumulated through fraudulent activity, suspicious behavior, or any
        means in violation of these Terms and Conditions, or in any manner
        inconsistent with the purpose or intention of the rewards system. This
        includes but is not limited to, the usage of automated methods,
        deception, or misrepresentation of any sort. No appeal or challenge
        process shall be available to the user in relation to any such decision
        by Web3app. By using the services of Web3app, you agree to these terms
        and acknowledge that the decision of Web3app in these matters is final
        and binding.
      </p>
      <p className="text-white text-lg font-bold">
      ...
      <p className="text-white text-sm text-normal py-4">
        The Site or applications does not offer users to submit or post content.
        ...
        of the Site and through third-party websites. As such, any Contributions
        you transmit may be treated in accordance with the Site or applications
      ...
      <p className="text-white text-sm text-normal py-4">
        ...
        <br></br>- You are the creator and owner of or have the necessary
        ...
        Contributions in any manner contemplated by the Site or applications and
        these Terms of Use.
        <br></br>- You have the written consent, release, and/or permission of
        ...
        <br></br>- Your Contributions do not violate any applicable law,
        regulation, or rule.
        <br></br>- Your Contributions do not violate the privacy or publicity
        ...
        <br></br>- Your Contributions do not include any offensive comments that
        are connected to race, national origin, gender, sexual preference, or
        physical handicap.
        <br></br>- Your Contributions do not otherwise violate, or link to
        material that violates, any provision of these Terms of Use, or any
        applicable law or regulation.
      </p>
      <p className="text-white text-sm text-normal py-4">
        Any use of the Site or applications in violation of the foregoing
        violates these Terms and Conditions and may result in, among other
        things, termination or suspension of your rights to use the Site and
        applications.
      </p>
      <p className="text-white text-lg font-bold">12. CONTRIBUTION LICENSE</p>
      <p className="text-white text-sm text-normal py-4">
        You and the Site or applications agree that we may access, store,
      ...
      <p className="text-white text-sm text-normal py-4">
        By submitting suggestions or other feedback regarding the Site or
        applications, you agree that we can use and share such feedback for any
      ...
      <p className="text-white text-sm text-normal py-4">
        ...
        Contributions provided by you in any area on the Site or applications.
        You are solely responsible for your Contributions to the Site or
        applications and you expressly agree to exonerate us from any and all
      ...
      <p className="text-white text-sm font-bold">Use License</p>
      <p className="text-white text-sm text-normal py-4">
        ...
        proprietary information or any of our interfaces or our oth r
      ...
      <p className="text-white text-sm font-bold">Apple and Android Devices</p>
      <p className="text-white text-sm text-normal py-4">
        ...
        set forth in the applicable App Distributor&apos;s terms of service; (2)
      ...
      <p className="text-white text-lg font-bold">14. SUBMISSIONS</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-lg font-bold">16. ADVERTISERS</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-lg font-bold">17. SITE MANAGEMENT</p>
      <p className="text-white text-sm text-normal py-4">
        We reserve the right, but not the obligation, to: (1) monitor the Site
        or applications for violations of these Terms of Conditions; (2) take
        ...
        and without limitation, notice, or liability, to remove from the Site,
        applications or otherwise disable all files and content that are
      ...
      <p className="text-white text-lg font-bold">18. TERM AND TERMINATION</p>
      <p className="text-white text-sm text-normal py-4">
        These terms of use shall remain in full force and effect while you use
        the site and applications. without limiting any other provision of these
      ...
      <p className="text-white text-lg font-bold">19. GOVERNING LAW</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-lg font-bold">20. DISPUTE RESOLUTION</p>
      <p className="text-white text-sm font-bold">Informal Negotiations</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-sm font-bold">Binding Arbitration</p>
      <p className="text-white text-sm text-normal py-4">
        ...
        in United States, Delaware. Except as otherwise provided herein, the
      ...
      <p className="text-white text-sm text-normal py-4">
        ...
        courts located in Delaware, and the parties hereby consent to, and waive
      ...
      <p className="text-white text-sm text-normal py-4">Restrictions</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-lg font-bold">21. CORRECTIONS</p>
      <p className="text-white text-sm text-normal py-4">
        There may be information on the Site or applications that contains
      ...
      <p className="text-white text-lg font-bold">22. DISCLAIMER</p>
      <p className="text-white text-sm text-normal py-4">
        The site and applications is provided on an as-is and as-available
      ...
      <p className="text-white text-sm text-normal py-4">
        In no event will our directors, employees, or we or agents be liable to
        ...
        additional rights. We are not liable for any losses made as a
        consequence of using any trading techniques obtained from our Site.
      </p>
      <p className="text-white text-lg font-bold">24. INDEMNIFICATION</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-lg font-bold">25. USER DATA</p>
      <p className="text-white text-sm text-normal py-4">
      ...
      <p className="text-white text-lg font-bold">26. MISCELLANEOUS</p>
      <p className="text-white text-sm text-normal py-4">
